...
- [x] D `clock` CLI (daysUntil/daysOverdue vs 2026-09-11 and 2027-12-11 without evidence-pack zip; optional local `--advisories` match; calendar helper, not a CRA certificate; smoke `clock-cli-ok`)
