#!/usr/bin/env python3
"""Tiny mock HTTP webhook receiver for C agent-ci local-mvp.
...
from agent_ci.webhook import SIGNATURE_HEADER, TIMESTAMP_HEADER, verify_webhook_signature  # noqa: E402
