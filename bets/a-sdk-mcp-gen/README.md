...
- [x] Generated Java / Kotlin / C# clients throw typed `ApiError` after retries (same policy as TS/Python/Go). Smoke prints typed-errors-ok. Rust / PHP / Swift / Ruby still surface raw HTTP failures.
