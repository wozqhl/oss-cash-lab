...
echo "   (pack.json clock + CLOCK.md + CycloneDX/SPDX/OpenVEX — inventory helper only)."
echo "   Optional: ai-bom clock --format md|html for Slack/PR or self-contained HTML."
