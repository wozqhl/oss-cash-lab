...
- [x] SPDX 3.0.1 JSON export (`scan --format spdx3`; `GET /v1/bom?format=spdx3`; compact `spdxId`/`name`/`creationInfo.specVersion=3.0.1` + packages/licenses; SPDX 2.3 `spdx`/`spdx-xml` unchanged)
